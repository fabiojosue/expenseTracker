...
/**
 * Loads the sidebar HTML content and inserts it into the sidenav element.
...
function loadSidebar() {
    const sidenavHTML = `
        ...
        <button class="sdvButton" onclick="goToSettings()">
        ...
        <hr class="divider">
        <button class="sdvButton" onclick="goToLogin()">
    ...
    if (sidenavElement) {
        sidenavElement.innerHTML = sidenavHTML;
    } else {
        console.error('Element with id "sidenav" not found.');
    }
}

//Toggles the visibility of the sidebar by adding or removing the 'active' class.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add event listener to the navbar button to toggle the sidebar
    const navbarButton = document.getElementById('navbarButton');
    if (navbarButton) {
        navbarButton.addEventListener('click', toggleSidebar);
    }
});
